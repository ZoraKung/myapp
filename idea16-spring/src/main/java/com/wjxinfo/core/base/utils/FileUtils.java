...
//        displayFilename = displayFilename.replace(" ", "_");
    ...
    public static boolean zip(final String outputZipFilename, final List<String> inputFilenames) {
        return zipAndEncrypt(outputZipFilename, inputFilenames, null);
    }

    public static boolean zipAndEncrypt(final String outputZipFilename, final List<String> sourceFiles, String
            password) {
        byte[] buffer = new byte[4096];
        try {

            FileOutputStream fos = new FileOutputStream(outputZipFilename + ".zip");
