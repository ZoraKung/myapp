...
<div class="controls">
    <select style="width:60px" id="${id}dateday" ${readonly} type="hidden"
            onchange="${id}changeday();" class="hidden ${css}">
        <option value=""></option>
    </select>
    <select style="width:85px" id="${id}datemonth" ${readonly} class="${css}"
            onchange="${id}changedate('${id}dateyear','${id}datemonth','${id}dateday');">
        <option value=""></option>
    </select> - 
    <select style="width:110px" id="${id}dateyear"  ${readonly} class="${css}"
            onchange="${id}changedate('${id}dateyear','${id}datemonth','${id}dateday'); ">
        <option value=""></option>
    </select>
</div>
