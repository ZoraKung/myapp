    ...
    b.jgrid.extend({getGridParam: function (b) {
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                // Added by Carey on 2015-08-11 to set min height to 200px
                if (isNaN(d) || d < 150) {
                	d = 150;
                } 
...
(function (a) {
    ...
    a.fn.fmatter.rowactions = function (c) {
        var b = a(this).closest("tr.jqgrow"), d = b.attr("id"), e = a(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), e = a("#" + e), f = e[0], g = f.p, h = g.colModel[a.jgrid.getCellIndex(this)],
            j = h.frozen ? a("tr#" + d + " td:eq(" + a.jgrid.getCellIndex(this) + ") > div", e) : a(this).parent(), i = {keys: !1, beforeOnEdit:null,onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null, restoreAfterError: !0, mtype: "POST", delOptions: {}, editOptions: {}}, k = function (b) {
        ...
        b = {keys: i.keys, beforeOnEditfunc: i.beforeOnEdit,oneditfunc:  i.onEdit, successfunc: i.onSuccess, url: i.url, extraparam: i.extraparam, aftersavefunc: function (b, c) {
        ...
        switch (c) {
            case "edit":
                if(a.isFunction(i.beforeOnEdit)) if(!i.beforeOnEdit.call()) return;
...
(function (a) {
    ...
    a.jgrid.extend({editRow: function (c, b, e, o, l, g, n, h, f) {
        ...
        j = a.extend(!0, {keys: !1, beforeOnEditfunc:null,oneditfunc: null, successfunc: null, url: null,
